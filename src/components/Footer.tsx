  ...
  return (
    <footer className="bg-gray-900 text-white py-12">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 pt-8 border-t border-gray-800 text-center text-gray-400 text-sm">
        <p>Developed and Designed by <a href="https://digitalcomrade.in" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Digital Comrade</a> &copy; {new Date().getFullYear()} Aspire International School. All rights reserved.</p>
      </div>
    </footer>
  );
}
